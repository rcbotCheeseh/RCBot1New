...
void Meta_ClientCommand(void)
{
	RCBotCommands_MainCommand::ClientCommand();
}
...
C_DLLEXPORT int Meta_Attach(PLUG_LOADTIME now, META_FUNCTIONS* pFunctionTable, meta_globals_t* pMGlobals, gamedll_funcs_t* pGamedllFuncs)
{
	...
	{
		//BotMessage(nullptr, 2, "Err: Received nullptr pFunctionTable from Metamod... not my fault... check running plugins!!!");
	}
